...
func (ChannelBank) TableName() string {
	return "ch_channel_banks"
}
...
func (o *NameI18n) Scan(input interface{}) error {
	return json.Unmarshal(input.([]byte), o)
}

func (o NameI18n) Value() (driver.Value, error) {
	b, err := json.Marshal(o)
	return string(b), err
}

type ChannelData2 struct {
	ChannelData
...
type ChannelPayTypeQueryAmountRequestX struct {
	ChannelPayTypeQueryAmountRequest
	Orders []gormx.Sortx `json:"orders, optional" gorm:"-"`
}

type ChannelDataQueryAllResponseX struct {
	List     []ChannelData2 `json:"list"`
	PageNum  int            `json:"pageNum"`
	PageSize int            `json:"pageSize"`
	RowCount int64          `json:"rowCount"`
}

type ChannelDataQueryForBKProxyRequestX struct {
	ChannelDataQueryForBKProxyRequest
	Orders []gormx.Sortx `json:"orders, optional" gorm:"-"`
}
...
type ChannelRateRecordRequestX struct {
	ChannelRateRecordRequest
	Orders []gormx.Sortx `json:"orders, optional" gorm:"-"`
}

type ChannelRateRecordCreate struct {
	ChannelRateRecordCreateRequest
	CreatedAt time.Time
}
...
type MerchantRateQueryRequestX struct {
	MerchantRateQueryRequest
	Orders []gormx.Sortx `json:"orders, optional" gorm:"-"`
}
...
type WalletAddressQueryAllRequestX struct {
	WalletAddressQueryAllRequest
	Orders []gormx.Sortx `json:"orders, optional" gorm:"-"`
}

type WalletAddressQueryAllResponseX struct {
	List     []WalletAddressX `json:"list"`
	PageNum  int              `json:"pageNum"`
	PageSize int              `json:"pageSize"`
	RowCount int64            `json:"rowCount"`
}

type ChannelBalanceNotify struct {
	SuccessList []string `json:"successList"`
	FailList    []string `json:"failList"`
}

type ChannelBalanceRecordX struct {
	ChannelBalanceRecord
	CreatedAt JsonTime `json:"createdAt"`
	UpdatedAt JsonTime `json:"updatedAt"`
}

type ChannelBalanceRecordQuery struct {
	ChannelBalanceRecord
...
type ChannelBalanceRecordQueryAllRequestX struct {
	ChannelBalanceRecordQueryAllRequest
	Orders []gormx.Sortx `json:"orders, optional" gorm:"-"`
}

type ChannelBalanceRecordQueryAllResponseX struct {
	List     []ChannelBalanceRecordQuery `json:"list"`
	PageNum  int                         `json:"pageNum"`
	PageSize int                         `json:"pageSize"`
	RowCount int64                       `json:"rowCount"`
}
