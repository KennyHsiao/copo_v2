...
type MerchantGetCodeDropDownListLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewMerchantGetCodeDropDownListLogic(ctx context.Context, svcCtx *svc.ServiceContext) MerchantGetCodeDropDownListLogic {
	return MerchantGetCodeDropDownListLogic{
...
func (l *MerchantGetCodeDropDownListLogic) MerchantGetCodeDropDownList(req types.MerchantRateGetCodeDropDownListRequest) (resp []string, err error) {
	//var terms []string
	...
	if err = db.Order("mer_code asc").
		Distinct().
		Pluck("mer_code", &resp).Error; err != nil {
