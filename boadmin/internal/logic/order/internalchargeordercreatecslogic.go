...
import (
	...
	"com.copo/bo_service/boadmin/internal/service/orderfeeprofitservice"
...
type InternalChargeOrderCreateCsLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewInternalChargeOrderCreateCsLogic(ctx context.Context, svcCtx *svc.ServiceContext) InternalChargeOrderCreateCsLogic {
	return InternalChargeOrderCreateCsLogic{
...
func (l *InternalChargeOrderCreateCsLogic) InternalChargeOrderCreateCs(req types.OrderInternalCreate) error {
...
func (l *InternalChargeOrderCreateCsLogic) MultifileUpload(req types.OrderInternalCreate) (resp string, err error) {
...
func (l *InternalChargeOrderCreateCsLogic) RemoveFile(path string) error {
...
func (l *InternalChargeOrderCreateCsLogic) createInternalOrder(db *gorm.DB, req types.OrderInternalCreate, merchantOrderRateListView types.MerchantOrderRateListViewX,
...
func (l *InternalChargeOrderCreateCsLogic) generateRpcData(req *types.OrderX, rate *types.MerchantOrderRateListViewX, merchantCode string, userAccount string) (*transaction.InternalOrder, *transaction.MerchantOrderRateListView) {
