...
func SystemIpUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemIpRequest
		...
		l := systemrate.NewSystemIpUpdateLogic(r.Context(), ctx)
		err := l.SystemIpUpdate(&req)
		if err != nil {
