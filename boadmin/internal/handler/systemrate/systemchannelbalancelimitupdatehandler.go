...
func SystemChannelBalanceLimitUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemChannelBalanceLimitUpdateRequest
		...
		l := systemrate.NewSystemChannelBalanceLimitUpdateLogic(r.Context(), ctx)
		err := l.SystemChannelBalanceLimitUpdate(&req)
		if err != nil {
