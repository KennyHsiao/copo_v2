...
func SystemRateCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemRateRequest
		...
		l := systemrate.NewSystemRateCreateLogic(r.Context(), ctx)
		err := l.SystemRateCreate(&req)
		if err != nil {
