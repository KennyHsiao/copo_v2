...
func SystemRateUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemRateUpdateRequest
		...
		l := systemrate.NewSystemRateUpdateLogic(r.Context(), ctx)
		err := l.SystemRateUpdate(&req)
		if err != nil {
