...
import (
	"com.copo/bo_service/boadmin/internal/logic/orderaction"
...
func OrderActionQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OrderActionQueryAllRequestX
		...
		l := orderaction.NewOrderActionQueryAllLogic(r.Context(), ctx)
		resp, err := l.OrderActionQueryAll(req)
		if err != nil {
