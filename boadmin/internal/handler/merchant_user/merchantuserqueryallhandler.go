...
func MerchantUserQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUserQueryAllRequestX
		...
		l := merchant_user.NewMerchantUserQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantUserQueryAll(req)
		if err != nil {
