...
func MerchantUserResetPasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUserResetPasswordRequest
		...
		l := merchant_user.NewMerchantUserResetPasswordLogic(r.Context(), ctx)
		err := l.MerchantUserResetPassword(req)
		if err != nil {
