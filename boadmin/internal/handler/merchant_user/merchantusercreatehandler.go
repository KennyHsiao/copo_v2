...
func MerchantUserCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUserCreateRequest
		...
		l := merchant_user.NewMerchantUserCreateLogic(r.Context(), ctx)
		err := l.MerchantUserCreate(req)
		if err != nil {
