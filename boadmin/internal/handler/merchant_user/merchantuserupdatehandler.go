...
func MerchantUserUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUserUpdateRequest
		...
		l := merchant_user.NewMerchantUserUpdateLogic(r.Context(), ctx)
		err := l.MerchantUserUpdate(req)
		if err != nil {
