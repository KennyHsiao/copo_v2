...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchant_user"
...
func MerchantUserUpdatePasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUserUpdatePasswordRequest
		...
		l := merchant_user.NewMerchantUserUpdatePasswordLogic(r.Context(), ctx)
		err := l.MerchantUserUpdatePassword(req)
		if err != nil {
