...
func AnnouncementUpdateDraftHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementUpdateDraftRequest
		...
		l := announcement.NewAnnouncementUpdateDraftLogic(r.Context(), ctx)
		err := l.AnnouncementUpdateDraft(&req)
		if err != nil {
