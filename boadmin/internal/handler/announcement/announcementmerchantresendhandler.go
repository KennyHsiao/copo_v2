...
func AnnouncementMerchantResendHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementMerchantResendRequest
		...
		l := announcement.NewAnnouncementMerchantResendLogic(r.Context(), ctx)
		err := l.AnnouncementMerchantResend(&req)
		if err != nil {
