...
func AnnouncementQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementQueryRequest
		...
		l := announcement.NewAnnouncementQueryLogic(r.Context(), ctx)
		resp, err := l.AnnouncementQuery(&req)
		if err != nil {
