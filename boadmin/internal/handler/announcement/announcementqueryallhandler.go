...
func AnnouncementQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementQueryAllRequestX
		...
		l := announcement.NewAnnouncementQueryAllLogic(r.Context(), ctx)
		resp, err := l.AnnouncementQueryAll(req)
		if err != nil {
