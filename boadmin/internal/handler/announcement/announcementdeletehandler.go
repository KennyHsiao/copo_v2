...
func AnnouncementDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementDeleteRequest
		...
		l := announcement.NewAnnouncementDeleteLogic(r.Context(), ctx)
		err := l.AnnouncementDelete(&req)
		if err != nil {
