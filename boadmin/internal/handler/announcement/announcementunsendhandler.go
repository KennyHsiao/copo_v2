...
func AnnouncementUnsendHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementUnsendRequest
		...
		l := announcement.NewAnnouncementUnsendLogic(r.Context(), ctx)
		err := l.AnnouncementUnsend(&req)
		if err != nil {
