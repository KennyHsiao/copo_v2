...
func AnnouncementCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementCreateRequest
		...
		l := announcement.NewAnnouncementCreateLogic(r.Context(), ctx)
		err := l.AnnouncementCreate(req)
		if err != nil {
