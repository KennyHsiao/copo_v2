...
func AnnouncementResendHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementResendRequest
		...
		l := announcement.NewAnnouncementResendLogic(r.Context(), ctx)
		err := l.AnnouncementResend(&req)
		if err != nil {
