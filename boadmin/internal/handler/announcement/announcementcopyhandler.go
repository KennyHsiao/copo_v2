...
func AnnouncementCopyHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementCopyRequest
		...
		l := announcement.NewAnnouncementCopyLogic(r.Context(), ctx)
		err := l.AnnouncementCopy(&req)
		if err != nil {
