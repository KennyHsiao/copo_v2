...
import (
	"com.copo/bo_service/boadmin/internal/logic/announcement"
...
func AnnouncementMerchantIgnoreHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementMerchantIgnoreRequest
		...
		l := announcement.NewAnnouncementMerchantIgnoreLogic(r.Context(), ctx)
		err := l.AnnouncementMerchantIgnore(&req)
		if err != nil {
