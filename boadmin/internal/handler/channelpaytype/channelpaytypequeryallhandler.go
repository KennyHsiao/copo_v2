...
func ChannelPayTypeQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelPayTypeQueryAllRequestX
		...
		l := channelpaytype.NewChannelPayTypeQueryAllLogic(r.Context(), ctx)
		resp, err := l.ChannelPayTypeQueryAll(req)
		if err != nil {
