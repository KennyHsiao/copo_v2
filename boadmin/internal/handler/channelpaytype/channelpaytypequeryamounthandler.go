...
func ChannelPayTypeQueryAmountHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelPayTypeQueryAmountRequestX
		...
		l := channelpaytype.NewChannelPayTypeQueryAmountLogic(r.Context(), ctx)
		resp, err := l.ChannelPayTypeQueryAmount(&req)
		if err != nil {
