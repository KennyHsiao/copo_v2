...
func ChannelPayTypeMerRateUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateUpdateRequest
		...
		l := channelpaytype.NewChannelPayTypeMerRateUpdateLogic(r.Context(), ctx)
		err := l.ChannelPayTypeMerRateUpdate(&req)
		if err != nil {
