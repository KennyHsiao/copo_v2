...
func ChannelPayTypeMerchantRateQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateQueryRequestX
		...
		l := channelpaytype.NewChannelPayTypeMerchantRateQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelPayTypeMerchantRateQuery(&req)
		if err != nil {
