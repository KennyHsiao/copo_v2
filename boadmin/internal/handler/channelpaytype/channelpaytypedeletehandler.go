...
func ChannelPayTypeDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelPayTypeDeleteRequest
		...
		l := channelpaytype.NewChannelPayTypeDeleteLogic(r.Context(), ctx)
		err := l.ChannelPayTypeDelete(req)
		if err != nil {
