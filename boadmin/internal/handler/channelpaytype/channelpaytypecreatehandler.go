...
func ChannelPayTypeCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelPayTypeCreateRequest
		...
		l := channelpaytype.NewChannelPayTypeCreateLogic(r.Context(), ctx)
		err := l.ChannelPayTypeCreate(req)
		if err != nil {
