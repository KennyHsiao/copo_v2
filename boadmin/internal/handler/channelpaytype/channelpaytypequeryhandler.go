...
func ChannelPayTypeQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelPayTypeQueryRequest
		...
		l := channelpaytype.NewChannelPayTypeQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelPayTypeQuery(req, language)
		if err != nil {
