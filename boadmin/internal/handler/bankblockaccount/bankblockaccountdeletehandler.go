...
func BankBlockAccountDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankBlockAccountDeleteRequest
		...
		l := bankblockaccount.NewBankBlockAccountDeleteLogic(r.Context(), ctx)
		err := l.BankBlockAccountDelete(req)
		if err != nil {
