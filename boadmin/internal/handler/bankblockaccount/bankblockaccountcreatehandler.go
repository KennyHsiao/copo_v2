...
func BankBlockAccountCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankBlockAccountCreateRequest
		...
		l := bankblockaccount.NewBankBlockAccountCreateLogic(r.Context(), ctx)
		err := l.BankBlockAccountCreate(req)
		if err != nil {
