...
func BankBlockAccountUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankBlockAccountUpdateRequest
		...
		l := bankblockaccount.NewBankBlockAccountUpdateLogic(r.Context(), ctx)
		err := l.BankBlockAccountUpdate(req)
		if err != nil {
