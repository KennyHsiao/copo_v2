...
func BankBlockAccountQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankBlockAccountQueryAllRequest
		...
		l := bankblockaccount.NewBankBlockAccountQueryAllLogic(r.Context(), ctx)
		resp, err := l.BankBlockAccountQueryAll(req)
		if err != nil {
