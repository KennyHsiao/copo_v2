...
func ChannelBankCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBankCreateRequest
		...
		l := channelbank.NewChannelBankCreateLogic(r.Context(), ctx)
		err := l.ChannelBankCreate(req)
		if err != nil {
