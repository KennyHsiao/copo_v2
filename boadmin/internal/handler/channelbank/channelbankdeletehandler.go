...
func ChannelBankDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBankDeleteRequest
		...
		l := channelbank.NewChannelBankDeleteLogic(r.Context(), ctx)
		err := l.ChannelBankDelete(req)
		if err != nil {
