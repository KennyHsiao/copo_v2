...
func ChannelBankUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBankUpdateRequest
		...
		l := channelbank.NewChannelBankUpdateLogic(r.Context(), ctx)
		err := l.ChannelBankUpdate(req)
		if err != nil {
