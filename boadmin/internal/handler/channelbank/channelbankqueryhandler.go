...
func ChannelBankQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBankQueryRequest
		...
		l := channelbank.NewChannelBankQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelBankQuery(req)
		if err != nil {
