...
import (
	"com.copo/bo_service/boadmin/internal/logic/channelbank"
...
func ChannelBankQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBankQueryAllRequest
		...
		l := channelbank.NewChannelBankQueryAllLogic(r.Context(), ctx)
		resp, err := l.ChannelBankQueryAll(req)
		if err != nil {
