...
func MerchantBalanceCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBalanceCreateRequest
		...
		l := merchantbalance.NewMerchantBalanceCreateLogic(r.Context(), ctx)
		err := l.MerchantBalanceCreate(req)
		if err != nil {
