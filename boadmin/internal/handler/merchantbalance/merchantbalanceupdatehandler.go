...
func MerchantBalanceUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBalanceUpdateRequest
		...
		l := merchantbalance.NewMerchantBalanceUpdateLogic(r.Context(), ctx)
		err := l.MerchantBalanceUpdate(req)
		if err != nil {
