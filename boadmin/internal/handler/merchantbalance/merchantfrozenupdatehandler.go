...
func MerchantFrozenUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantFrozenUpdateRequest
		...
		l := merchantbalance.NewMerchantFrozenUpdateLogic(r.Context(), ctx)
		err := l.MerchantFrozenUpdate(req)
		if err != nil {
