...
func MerchantBalanceQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBalanceQueryRequest
		...
		l := merchantbalance.NewMerchantBalanceQueryLogic(r.Context(), ctx)
		resp, err := l.MerchantBalanceQuery(req)
		if err != nil {
