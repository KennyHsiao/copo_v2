...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantbalance"
...
func MerchantBalanceQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBalanceQueryAllRequest
		...
		l := merchantbalance.NewMerchantBalanceQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantBalanceQueryAll(req)
		if err != nil {
