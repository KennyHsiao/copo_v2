...
func UserUnfreezeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserUnfreezeRequest
		...
		l := admin_user.NewUserUnfreezeLogic(r.Context(), ctx)
		err := l.UserUnfreeze(&req)
		if err != nil {
