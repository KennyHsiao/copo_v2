...
func UserQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserQueryAllRequest
		...
		l := admin_user.NewUserQueryAllLogic(r.Context(), ctx)
		resp, err := l.UserQueryAll(req)
		if err != nil {
