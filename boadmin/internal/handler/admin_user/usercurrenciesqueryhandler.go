...
import (
	"com.copo/bo_service/boadmin/internal/logic/admin_user"
...
func UserCurrenciesQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserCurrenciesQueryRequest
		...
		l := admin_user.NewUserCurrenciesQueryLogic(r.Context(), ctx)
		resp, err := l.UserCurrenciesQuery(req)
		if err != nil {
