...
func UserResetHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserResetRequest
		...
		l := admin_user.NewUserResetLogic(r.Context(), ctx)
		_, err := l.UserReset(req)
		if err != nil {
