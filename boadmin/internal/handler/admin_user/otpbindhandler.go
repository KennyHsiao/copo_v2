...
func OtpBindHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OtpBindRequest
		...
		l := admin_user.NewOtpBindLogic(r.Context(), ctx)
		resp, err := l.OtpBind(req)
		if err != nil {
