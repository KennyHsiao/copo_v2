...
import (
	"com.copo/bo_service/boadmin/internal/logic/systemparam"
...
func SystemParamQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemParamQueryAllRequest
		...
		l := systemparam.NewSystemParamQueryAllLogic(r.Context(), ctx)
		resp, err := l.SystemParamQueryAll(&req)
		if err != nil {
