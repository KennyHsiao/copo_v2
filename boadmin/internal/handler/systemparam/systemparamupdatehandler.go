...
func SystemParamUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SystemParamUpdateRequest
		...
		l := systemparam.NewSystemParamUpdateLogic(r.Context(), ctx)
		err := l.SystemParamUpdate(&req)
		if err != nil {
