...
func ChannelRuleQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelRuleQueryRequestX
		...
		l := announcementTemp.NewChannelRuleQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelRuleQuery(req)
		if err != nil {
