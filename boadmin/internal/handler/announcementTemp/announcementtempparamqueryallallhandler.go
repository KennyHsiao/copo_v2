...
import (
	"com.copo/bo_service/boadmin/internal/logic/announcementTemp"
...
func AnnouncementTempParamQueryAllAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementTempParamQueryAllRequestX
		...
		l := announcementTemp.NewAnnouncementTempParamQueryAllAllLogic(r.Context(), ctx)
		resp, err := l.AnnouncementTempParamQueryAllAll(req)
		if err != nil {
