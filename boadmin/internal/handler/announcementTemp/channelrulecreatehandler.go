...
func ChannelRuleCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelRuleCreateRequest
		...
		l := announcementTemp.NewChannelRuleCreateLogic(r.Context(), ctx)
		err := l.ChannelRuleCreate(req)
		if err != nil {
