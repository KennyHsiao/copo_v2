...
func ChannelRuleUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelRuleUpdateRequest
		...
		l := announcementTemp.NewChannelRuleUpdateLogic(r.Context(), ctx)
		err := l.ChannelRuleUpdate(req)
		if err != nil {
