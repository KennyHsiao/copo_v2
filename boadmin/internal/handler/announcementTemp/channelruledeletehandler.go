...
func ChannelRuleDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelRuleDeleteRequest
		...
		l := announcementTemp.NewChannelRuleDeleteLogic(r.Context(), ctx)
		err := l.ChannelRuleDelete(&req)
		if err != nil {
