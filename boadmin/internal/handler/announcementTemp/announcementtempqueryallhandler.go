...
func AnnouncementTempQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AnnouncementTempQueryAllRequestX
		...
		l := announcementTemp.NewAnnouncementTempQueryAllLogic(r.Context(), ctx)
		resp, err := l.AnnouncementTempQueryAll(req)
		if err != nil {
