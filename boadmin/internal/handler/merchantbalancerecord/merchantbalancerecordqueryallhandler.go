...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantbalancerecord"
...
func MerchantBalanceRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBalanceRecordQueryAllRequestX
		...
		l := merchantbalancerecord.NewMerchantBalanceRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantBalanceRecordQueryAll(req)
		if err != nil {
