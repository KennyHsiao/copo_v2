...
import (
	"com.copo/bo_service/boadmin/internal/logic/channelraterecord"
...
func ChannelRateRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelRateRecordRequestX
		...
		l := channelraterecord.NewChannelRateRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.ChannelRateRecordQueryAll(&req)
		if err != nil {
