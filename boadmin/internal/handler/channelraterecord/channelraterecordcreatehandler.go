...
func ChannelRateRecordCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelRateRecordCreateRequest
		...
		l := channelraterecord.NewChannelRateRecordCreateLogic(r.Context(), ctx)
		err := l.ChannelRateRecordCreate(&req)
		if err != nil {
