...
func PermitUpsertHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PermitUpsertRequest
		...
		l := permit.NewPermitUpsertLogic(r.Context(), ctx)
		err := l.PermitUpsert(req)
		if err != nil {
