...
func PermitDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PermitDeleteRequest
		...
		l := permit.NewPermitDeleteLogic(r.Context(), ctx)
		err := l.PermitDelete(req)
		if err != nil {
