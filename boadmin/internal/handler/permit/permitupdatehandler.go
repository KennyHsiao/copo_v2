...
func PermitUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PermitUpdateRequest
		...
		l := permit.NewPermitUpdateLogic(r.Context(), ctx)
		err := l.PermitUpdate(req)
		if err != nil {
