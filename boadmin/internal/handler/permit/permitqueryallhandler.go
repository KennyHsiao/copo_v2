...
import (
	"com.copo/bo_service/boadmin/internal/logic/permit"
...
func PermitQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PermitQueryAllRequest
		...
		l := permit.NewPermitQueryAllLogic(r.Context(), ctx)
		resp, err := l.PermitQueryAll(req)
		if err != nil {
