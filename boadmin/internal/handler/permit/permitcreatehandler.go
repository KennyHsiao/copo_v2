...
func PermitCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PermitCreateRequest
		...
		l := permit.NewPermitCreateLogic(r.Context(), ctx)
		err := l.PermitCreate(req)
		if err != nil {
