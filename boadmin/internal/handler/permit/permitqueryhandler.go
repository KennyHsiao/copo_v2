...
func PermitQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PermitQueryRequest
		...
		l := permit.NewPermitQueryLogic(r.Context(), ctx)
		resp, err := l.PermitQuery(req)
		if err != nil {
