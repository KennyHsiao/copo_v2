...
import (
	"com.copo/bo_service/boadmin/internal/logic/orderlog"
...
func TransactionLogQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OrderLogQueryAllRequestX
		...
		l := orderlog.NewTransactionLogQueryAllLogic(r.Context(), ctx)
		resp, err := l.TransactionLogQueryAll(&req)
		if err != nil {
