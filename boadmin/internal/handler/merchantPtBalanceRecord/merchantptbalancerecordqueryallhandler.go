...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantPtBalanceRecord"
...
func MerchantPtBalanceRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtBalanceRecordQueryAllRequest
		...
		l := merchantPtBalanceRecord.NewMerchantPtBalanceRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantPtBalanceRecordQueryAll(&req)
		if err != nil {
