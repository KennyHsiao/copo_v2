...
import (
	"com.copo/bo_service/boadmin/internal/logic/orderfeeprofit"
...
func OrderFeeProfitQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OrderFeeProfitQueryAllRequest
		...
		l := orderfeeprofit.NewOrderFeeProfitQueryAllLogic(r.Context(), ctx)
		resp, err := l.OrderFeeProfitQueryAll(req)
		if err != nil {
