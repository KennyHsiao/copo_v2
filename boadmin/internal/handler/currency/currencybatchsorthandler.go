...
func CurrencyBatchSortHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CurrencyBatchSortRequest
		...
		l := currency.NewCurrencyBatchSortLogic(r.Context(), ctx)
		err := l.CurrencyBatchSort(&req)
		if err != nil {
