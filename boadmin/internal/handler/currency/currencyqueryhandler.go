...
func CurrencyQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CurrencyQueryRequest
		...
		l := currency.NewCurrencyQueryLogic(r.Context(), ctx)
		resp, err := l.CurrencyQuery(req)
		if err != nil {
