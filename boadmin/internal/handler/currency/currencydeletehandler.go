...
func CurrencyDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CurrencyDeleteRequest
		...
		l := currency.NewCurrencyDeleteLogic(r.Context(), ctx)
		err := l.CurrencyDelete(req)
		if err != nil {
