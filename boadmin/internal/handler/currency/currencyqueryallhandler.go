...
import (
	"com.copo/bo_service/boadmin/internal/logic/currency"
...
func CurrencyQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CurrencyQueryAllRequestX
		...
		l := currency.NewCurrencyQueryAllLogic(r.Context(), ctx)
		resp, err := l.CurrencyQueryAll(req)
		if err != nil {
