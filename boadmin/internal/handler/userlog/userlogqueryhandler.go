...
import (
	"com.copo/bo_service/boadmin/internal/logic/userlog"
...
func UserLogQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserLogQueryAllRequestX
		...
		l := userlog.NewUserLogQueryLogic(r.Context(), ctx)
		resp, err := l.UserLogQuery(&req)
		if err != nil {
