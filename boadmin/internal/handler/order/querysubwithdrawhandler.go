...
func QuerySubWithdrawHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QuerySubWithdrawRequest
		...
		l := order.NewQuerySubWithdrawLogic(r.Context(), ctx)
		resp, err := l.QuerySubWithdraw(&req)
		if err != nil {
