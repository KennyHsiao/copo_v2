...
func OrderQueryMerchantChannelFeeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OrderQueryMerchantChannelFeeRequest
		...
		l := order.NewOrderQueryMerchantChannelFeeLogic(r.Context(), ctx)
		resp, err := l.OrderQueryMerchantChannelFee(req)
		if err != nil {
