...
func WithdrawOrderFeeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawOrderFeeRequest
		...
		l := order.NewWithdrawOrderFeeLogic(r.Context(), ctx)
		resp, err := l.WithdrawOrderFee(req)
		if err != nil {
