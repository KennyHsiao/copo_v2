...
func WithdrawOrderUpdateReviewProcessHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawOrderUpdateReviewProcssRequest
		...
		l := order.NewWithdrawOrderUpdateReviewProcessLogic(r.Context(), ctx)
		err := l.WithdrawOrderUpdateReviewProcess(req)
		if err != nil {
