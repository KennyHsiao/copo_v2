...
func PayOrderToTestHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PayOrderToTestRequest
		...
		l := order.NewPayOrderToTestLogic(r.Context(), ctx)
		resp, err := l.PayOrderToTest(&req)
		if err != nil {
