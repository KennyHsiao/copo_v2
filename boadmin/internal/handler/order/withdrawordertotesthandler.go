...
func WithdrawOrderToTestHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawOrderToTestRequest
		...
		l := order.NewWithdrawOrderToTestLogic(r.Context(), ctx)
		resp, err := l.WithdrawOrderToTest(&req)
		if err != nil {
