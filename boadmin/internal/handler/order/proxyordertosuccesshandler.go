...
func ProxyOrderToSuccessHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ProxyOrderToSuccessRequest
		...
		l := order.NewProxyOrderToSuccessLogic(r.Context(), ctx)
		resp, err := l.ProxyOrderToSuccess(&req)
		if err != nil {
