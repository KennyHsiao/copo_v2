...
func ProxyPayOrderCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MultipleOrderProxyCreateRequest
		...
		l := order.NewProxyPayOrderCreateLogic(r.Context(), ctx)
		resp, err := l.ProxyPayOrderCreate(req)
		if err != nil {
