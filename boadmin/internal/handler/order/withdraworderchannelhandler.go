...
func WithdrawOrderChannelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawOrderChannelRequest
		...
		l := order.NewWithdrawOrderChannelLogic(r.Context(), ctx)
		resp, err := l.WithdrawOrderChannel(req)
		if err != nil {
