...
func InternalChargeOrderCreateCsHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		orderX.MerchantCode = r.MultipartForm.Value["merchantCode"][0]
		...
		l := order.NewInternalChargeOrderCreateCsLogic(r.Context(), ctx)
		err := l.InternalChargeOrderCreateCs(req)
		if err != nil {
