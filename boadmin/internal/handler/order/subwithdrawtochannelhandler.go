...
func SubWithdrawToChannelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SubWithdrawToChannelRequest
		...
		l := order.NewSubWithdrawToChannelLogic(r.Context(), ctx)
		resp, err := l.SubWithdrawToChannel(&req)
		if err != nil {
