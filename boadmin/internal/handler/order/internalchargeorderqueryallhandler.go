...
func InternalChargeOrderQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InternalChargeOrderQueryAllRequest
		...
		l := order.NewInternalChargeOrderQueryAllLogic(r.Context(), ctx)
		resp, err := l.InternalChargeOrderQueryAll(req)
		if err != nil {
