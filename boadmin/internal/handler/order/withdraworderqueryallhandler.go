...
func WithdrawOrderQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithDrawOrderQueryAllRequest
		...
		l := order.NewWithdrawOrderQueryAllLogic(r.Context(), ctx)
		resp, err := l.WithdrawOrderQueryAll(req)
		if err != nil {
