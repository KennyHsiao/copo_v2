...
func ProxyOrderToTestHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ProxyOrderToTestRequest
		...
		l := order.NewProxyOrderToTestLogic(r.Context(), ctx)
		resp, err := l.ProxyOrderToTest(&req)
		if err != nil {
