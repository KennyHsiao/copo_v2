...
func WithdrawOrderCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MultipleOrderWithdrawCreateRequestX
		...
		l := order.NewWithdrawOrderCreateLogic(r.Context(), ctx)
		resp, err := l.WithdrawOrderCreate(req)
		if err != nil {
