...
func WithdrawReviewHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawOrderUpdateRequest
		...
		l := order.NewWithdrawReviewLogic(r.Context(), ctx)
		err := l.WithdrawReview(req)
		if err != nil {
