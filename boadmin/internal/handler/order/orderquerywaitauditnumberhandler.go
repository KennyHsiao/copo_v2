...
func OrderQueryWaitAuditNumberHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OrderQueryWaitAuditNumberRequest
		...
		l := order.NewOrderQueryWaitAuditNumberLogic(r.Context(), ctx)
		resp, err := l.OrderQueryWaitAuditNumber(req)
		if err != nil {
