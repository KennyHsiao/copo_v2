...
func WithdrawVerifyPasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawVerifyPasswordRequest
		...
		l := order.NewWithdrawVerifyPasswordLogic(r.Context(), ctx)
		err := l.WithdrawVerifyPassword(req)
		if err != nil {
