...
func TimezonexCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TimezonexCreateRequest
		...
		l := timezonex.NewTimezonexCreateLogic(r.Context(), ctx)
		err := l.TimezonexCreate(req)
		if err != nil {
