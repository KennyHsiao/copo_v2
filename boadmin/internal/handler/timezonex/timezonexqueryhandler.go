...
func TimezonexQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TimezonexQueryRequest
		...
		l := timezonex.NewTimezonexQueryLogic(r.Context(), ctx)
		resp, err := l.TimezonexQuery(req)
		if err != nil {
