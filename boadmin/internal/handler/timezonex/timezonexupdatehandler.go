...
func TimezonexUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TimezonexUpdateRequest
		...
		l := timezonex.NewTimezonexUpdateLogic(r.Context(), ctx)
		err := l.TimezonexUpdate(req)
		if err != nil {
