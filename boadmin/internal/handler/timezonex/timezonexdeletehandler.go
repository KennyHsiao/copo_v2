...
func TimezonexDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TimezonexDeleteRequest
		...
		l := timezonex.NewTimezonexDeleteLogic(r.Context(), ctx)
		err := l.TimezonexDelete(req)
		if err != nil {
