...
import (
	"com.copo/bo_service/boadmin/internal/logic/timezonex"
...
func TimezonexQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TimezonexQueryAllRequest
		...
		l := timezonex.NewTimezonexQueryAllLogic(r.Context(), ctx)
		resp, err := l.TimezonexQueryAll(req)
		if err != nil {
