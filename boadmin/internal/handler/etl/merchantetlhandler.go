...
func MerchantEtlHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRequest
		...
		l := etl.NewMerchantEtlLogic(r.Context(), ctx)
		err := l.MerchantEtl(&req)
		if err != nil {
