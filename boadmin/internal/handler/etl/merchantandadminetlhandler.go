...
func MerchantAndAdminEtlHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantAndAdminInfoRequest
		...
		l := etl.NewMerchantAndAdminEtlLogic(r.Context(), ctx)
		err := l.MerchantAndAdminEtl(&req)
		if err != nil {
