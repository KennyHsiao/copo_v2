...
func ChannelDataGetDropDownListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelDataGetDropDownListRequest
		...
		l := channeldata.NewChannelDataGetDropDownListLogic(r.Context(), ctx)
		resp, err := l.ChannelDataGetDropDownList(req)
		if err != nil {
