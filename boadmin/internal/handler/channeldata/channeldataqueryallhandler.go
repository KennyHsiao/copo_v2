...
func ChannelDataQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelDataQueryAllRequestX
		...
		l := channeldata.NewChannelDataQueryAllLogic(r.Context(), ctx)
		resp, err := l.ChannelDataQueryAll(req)
		if err != nil {
