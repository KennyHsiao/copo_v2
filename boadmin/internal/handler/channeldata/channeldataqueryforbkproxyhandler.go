...
func ChannelDataQueryForBKProxyHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelDataQueryForBKProxyRequestX
		...
		l := channeldata.NewChannelDataQueryForBKProxyLogic(r.Context(), ctx)
		resp, err := l.ChannelDataQueryForBKProxy(&req)
		if err != nil {
