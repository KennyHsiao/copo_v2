...
func ChannelDataQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelDataQueryRequest
		...
		l := channeldata.NewChannelDataQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelDataQuery(req)
		if err != nil {
