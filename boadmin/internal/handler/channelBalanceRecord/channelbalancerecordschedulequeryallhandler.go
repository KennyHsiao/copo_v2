...
func ChannelBalanceRecordScheduleQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBalanceRecordQueryAllRequestX
		...
		l := channelBalanceRecord.NewChannelBalanceRecordScheduleQueryAllLogic(r.Context(), ctx)
		resp, err := l.ChannelBalanceRecordScheduleQueryAll(&req)
		if err != nil {
