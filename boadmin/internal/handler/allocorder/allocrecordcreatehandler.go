...
func AllocRecordCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BKProxyCreateRequeset
		...
		l := allocorder.NewAllocRecordCreateLogic(r.Context(), ctx)
		resp, err := l.AllocRecordCreate(&req)
		if err != nil {
