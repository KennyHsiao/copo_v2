...
import (
	"com.copo/bo_service/boadmin/internal/logic/allocorder"
...
func AllocRecordTotalInfoHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AllocRecordQueryAllRequestX
		...
		l := allocorder.NewAllocRecordTotalInfoLogic(r.Context(), ctx)
		resp, err := l.AllocRecordTotalInfo(req)
		if err != nil {
