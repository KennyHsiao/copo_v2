...
func AllocRecordExcelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := allocorder.NewAllocRecordExcelLogic(r.Context(), ctx)
		xlsx, err := l.AllocRecordExcel(&req)
		if err != nil {
