...
func AllocRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := allocorder.NewAllocRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.AllocRecordQueryAll(req)
		if err != nil {
