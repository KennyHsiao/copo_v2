...
func ConfirmAllocOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ConfirmAllocOrderRequest
		...
		l := allocorder.NewConfirmAllocOrderLogic(r.Context(), ctx)
		err := l.ConfirmAllocOrder(&req)
		if err != nil {
