...
func ReviewProcessHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ReviewProcessRequest
		...
		l := report.NewReviewProcessLogic(r.Context(), ctx)
		resp, err := l.ReviewProcess(&req)
		if err != nil {
