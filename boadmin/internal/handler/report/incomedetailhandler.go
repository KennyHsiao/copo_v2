...
func IncomeDetailHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IncomeDetailRequest
		...
		l := report.NewIncomeDetailLogic(r.Context(), ctx)
		resp, err := l.IncomeDetail(&req)
		if err != nil {
