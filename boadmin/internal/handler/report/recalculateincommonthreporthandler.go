...
func ReCalculateIncomMonthReportHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ReCalculateIncomMonthReportRequest
		...
		l := report.NewReCalculateIncomMonthReportLogic(r.Context(), ctx)
		err := l.ReCalculateIncomMonthReport(&req)
		if err != nil {
