...
func WeeklyTransDetailHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WeeklyTransDetailRequest
		...
		l := report.NewWeeklyTransDetailLogic(r.Context(), ctx)
		resp, err := l.WeeklyTransDetail(&req)
		if err != nil {
