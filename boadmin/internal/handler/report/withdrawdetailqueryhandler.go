...
func WithdrawDetailQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WithdrawCheckBillQueryRequest
		...
		l := report.NewWithdrawDetailQueryLogic(r.Context(), ctx)
		resp, err := l.WithdrawDetailQuery(&req)
		if err != nil {
