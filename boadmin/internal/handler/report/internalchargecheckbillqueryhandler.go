...
func InternalChargeCheckBillQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewInternalChargeCheckBillQueryLogic(r.Context(), ctx)
		resp, err := l.InternalChargeCheckBillQuery(&req)
		if err != nil {
