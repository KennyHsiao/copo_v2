...
func ChannelReportQueryExcelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelReportQueryRequestX
		...
		l := report.NewChannelReportQueryExcelLogic(r.Context(), ctx)
		err := l.ChannelReportQueryExcel(&req)
		if err != nil {
