...
func ChannelReportQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewChannelReportQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelReportQuery(&req)
		if err != nil {
