...
func AppropriationCheckBillQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewAppropriationCheckBillQueryLogic(r.Context(), ctx)
		resp, err := l.AppropriationCheckBillQuery(&req)
		if err != nil {
