...
func TotalPayoutHandlingFeeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TotalPayoutHandlingFeeRequest
		...
		l := report.NewTotalPayoutHandlingFeeLogic(r.Context(), ctx)
		resp, err := l.TotalPayoutHandlingFee(&req)
		if err != nil {
