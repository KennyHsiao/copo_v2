...
func TotalDisplayHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TotalDisplayRequest
		...
		l := report.NewTotalDisplayLogic(r.Context(), ctx)
		resp, err := l.TotalDisplay(&req)
		if err != nil {
