...
func WithdrawCheckBillQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewWithdrawCheckBillQueryLogic(r.Context(), ctx)
		resp, err := l.WithdrawCheckBillQuery(&req)
		if err != nil {
