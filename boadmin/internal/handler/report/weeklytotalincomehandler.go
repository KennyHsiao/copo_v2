...
func WeeklyTotalIncomeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WeeklyTotalIncomeRequest
		...
		l := report.NewWeeklyTotalIncomeLogic(r.Context(), ctx)
		resp, err := l.WeeklyTotalIncome(&req)
		if err != nil {
