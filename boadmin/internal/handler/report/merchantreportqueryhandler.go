...
func MerchantReportQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewMerchantReportQueryLogic(r.Context(), ctx)
		resp, err := l.MerchantReportQuery(&req)
		if err != nil {
