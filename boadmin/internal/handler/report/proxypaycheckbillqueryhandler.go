...
func ProxyPayCheckBillQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewProxyPayCheckBillQueryLogic(r.Context(), ctx)
		resp, err := l.ProxyPayCheckBillQuery(&req)
		if err != nil {
