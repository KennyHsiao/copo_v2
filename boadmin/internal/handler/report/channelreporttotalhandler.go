...
func ChannelReportTotalHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := report.NewChannelReportTotalLogic(r.Context(), ctx)
		resp, err := l.ChannelReportTotal(&req)
		if err != nil {
