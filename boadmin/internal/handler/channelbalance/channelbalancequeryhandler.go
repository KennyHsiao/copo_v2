...
func ChannelBalanceQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBalanceQueryRequest
		...
		l := channelbalance.NewChannelBalanceQueryLogic(r.Context(), ctx)
		resp, err := l.ChannelBalanceQuery(&req)
		if err != nil {
