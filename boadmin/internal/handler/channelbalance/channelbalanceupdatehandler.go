...
func ChannelBalanceUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelBalanceUpdateRequest
		...
		l := channelbalance.NewChannelBalanceUpdateLogic(r.Context(), ctx)
		err := l.ChannelBalanceUpdate(&req)
		if err != nil {
