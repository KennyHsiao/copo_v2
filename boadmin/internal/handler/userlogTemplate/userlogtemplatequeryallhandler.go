...
import (
	"com.copo/bo_service/boadmin/internal/logic/userlogTemplate"
...
func UserLogTemplateQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserLogTemplateQueryAllRequestX
		...
		l := userlogTemplate.NewUserLogTemplateQueryAllLogic(r.Context(), ctx)
		resp, err := l.UserLogTemplateQueryAll(req)
		if err != nil {
