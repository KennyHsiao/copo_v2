...
func UserLogTemplateCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserLogTemplateCreateRequest
		...
		l := userlogTemplate.NewUserLogTemplateCreateLogic(r.Context(), ctx)
		err := l.UserLogTemplateCreate(req)
		if err != nil {
