...
func UserLogTemplateUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserLogTemplateUpdateRequest
		...
		l := userlogTemplate.NewUserLogTemplateUpdateLogic(r.Context(), ctx)
		err := l.UserLogTemplateUpdate(req)
		if err != nil {
