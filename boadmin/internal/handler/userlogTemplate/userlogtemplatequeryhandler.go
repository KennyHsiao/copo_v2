...
func UserLogTemplateQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserLogTemplateQueryRequest
		...
		l := userlogTemplate.NewUserLogTemplateQueryLogic(r.Context(), ctx)
		resp, err := l.UserLogTemplateQuery(&req)
		if err != nil {
