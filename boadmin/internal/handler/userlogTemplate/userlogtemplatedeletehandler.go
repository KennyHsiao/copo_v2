...
func UserLogTemplateDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserLogTemplateDeleteRequest
		...
		l := userlogTemplate.NewUserLogTemplateDeleteLogic(r.Context(), ctx)
		err := l.UserLogTemplateDelete(&req)
		if err != nil {
