...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantraterecord"
...
func MerchantRateRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateRecordRequestX
		...
		l := merchantraterecord.NewMerchantRateRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantRateRecordQueryAll(req)
		if err != nil {
