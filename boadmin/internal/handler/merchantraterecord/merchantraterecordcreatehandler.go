...
func MerchantRateRecordCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateRecordCreateRequest
		...
		l := merchantraterecord.NewMerchantRateRecordCreateLogic(r.Context(), ctx)
		err := l.MerchantRateRecordCreate(&req)
		if err != nil {
