...
import (
	"com.copo/bo_service/boadmin/internal/logic/announcementCallBack"
...
func AnnouncementSkypeCallBackHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SkypeCallBackRequest
		...
		l := announcementCallBack.NewAnnouncementSkypeCallBackLogic(r.Context(), ctx)
		err := l.AnnouncementSkypeCallBack(&req)
		if err != nil {
