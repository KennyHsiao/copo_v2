...
func CommissionWithdrawOrderQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommissionWithdrawOrderQueryAllRequestX
		...
		l := commissionWithdrawOrder.NewCommissionWithdrawOrderQueryAllLogic(r.Context(), ctx)
		resp, err := l.CommissionWithdrawOrderQueryAll(req)
		if err != nil {
