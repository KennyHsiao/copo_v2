...
import (
	"com.copo/bo_service/boadmin/internal/logic/login"
...
func OtpValidHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OtpValidRequest
		...
		l := login.NewOtpValidLogic(r.Context(), ctx)
		resp, err := l.OtpValid(req)
		if err != nil {
