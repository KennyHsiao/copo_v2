...
import (
	"com.copo/bo_service/boadmin/internal/logic/announcementGroup"
...
func GroupQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GroupQueryRequest
		...
		l := announcementGroup.NewGroupQueryLogic(r.Context(), ctx)
		resp, err := l.GroupQuery(req)
		if err != nil {
