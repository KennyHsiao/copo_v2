...
import (
	"com.copo/bo_service/boadmin/internal/logic/menu"
...
func MenuQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MenuQueryAllRequestX
		...
		l := menu.NewMenuQueryAllLogic(r.Context(), ctx)
		resp, err := l.MenuQueryAll(req)
		if err != nil {
