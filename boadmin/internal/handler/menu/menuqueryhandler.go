...
func MenuQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MenuQueryRequest
		...
		l := menu.NewMenuQueryLogic(r.Context(), ctx)
		resp, err := l.MenuQuery(req)
		if err != nil {
