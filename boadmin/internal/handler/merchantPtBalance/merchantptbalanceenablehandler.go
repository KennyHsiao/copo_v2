...
func MerchantPtBalanceEnableHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtEnableRequest
		...
		l := merchantPtBalance.NewMerchantPtBalanceEnableLogic(r.Context(), ctx)
		err := l.MerchantPtBalanceEnable(&req)
		if err != nil {
