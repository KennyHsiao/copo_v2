...
func MerchantPtBalanceUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtBalanceUpdateRequest
		...
		l := merchantPtBalance.NewMerchantPtBalanceUpdateLogic(r.Context(), ctx)
		err := l.MerchantPtBalanceUpdate(&req)
		if err != nil {
