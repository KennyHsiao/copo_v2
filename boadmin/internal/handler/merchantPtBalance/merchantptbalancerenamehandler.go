...
func MerchantPtBalanceRenameHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtBalanceRenameRequest
		...
		l := merchantPtBalance.NewMerchantPtBalanceRenameLogic(r.Context(), ctx)
		err := l.MerchantPtBalanceRename(&req)
		if err != nil {
