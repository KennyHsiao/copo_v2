...
func MerchantPtBalanceCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtBalanceCreateRequest
		...
		l := merchantPtBalance.NewMerchantPtBalanceCreateLogic(r.Context(), ctx)
		err := l.MerchantPtBalanceCreate(&req)
		if err != nil {
