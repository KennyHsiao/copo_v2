...
func MerchantPtBalanceDisableHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtDisableRequest
		...
		l := merchantPtBalance.NewMerchantPtBalanceDisableLogic(r.Context(), ctx)
		err := l.MerchantPtBalanceDisable(&req)
		if err != nil {
