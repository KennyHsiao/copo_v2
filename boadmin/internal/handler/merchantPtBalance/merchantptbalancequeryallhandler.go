...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantPtBalance"
...
func MerchantPtBalanceQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantPtBalanceQueryAllRequestX
		...
		l := merchantPtBalance.NewMerchantPtBalanceQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantPtBalanceQueryAll(req)
		if err != nil {
