...
func WalletAddressUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WalletAddressUpdateRequest
		...
		l := walletaddress.NewWalletAddressUpdateLogic(r.Context(), ctx)
		err := l.WalletAddressUpdate(&req)
		if err != nil {
