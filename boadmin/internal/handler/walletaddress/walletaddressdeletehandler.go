...
func WalletAddressDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WalletAddressDeleteRequest
		...
		l := walletaddress.NewWalletAddressDeleteLogic(r.Context(), ctx)
		err := l.WalletAddressDelete(&req)
		if err != nil {
