...
func GenerateKeyPairHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GenerateKeyPairRequest
		...
		l := walletaddress.NewGenerateKeyPairLogic(r.Context(), ctx)
		resp, err := l.GenerateKeyPair(&req)
		if err != nil {
