...
func WalletAddressCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WalletAddressCreateRequest
		...
		l := walletaddress.NewWalletAddressCreateLogic(r.Context(), ctx)
		err := l.WalletAddressCreate(&req)
		if err != nil {
