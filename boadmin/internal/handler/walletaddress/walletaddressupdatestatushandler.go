...
import (
	"com.copo/bo_service/boadmin/internal/logic/walletaddress"
...
func WalletAddressUpdateStatusHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WalletAddressUpdateStatusRequest
		...
		l := walletaddress.NewWalletAddressUpdateStatusLogic(r.Context(), ctx)
		err := l.WalletAddressUpdateStatus(&req)
		if err != nil {
