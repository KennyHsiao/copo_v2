...
func WalletAddressQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WalletAddressQueryRequest
		...
		l := walletaddress.NewWalletAddressQueryLogic(r.Context(), ctx)
		resp, err := l.WalletAddressQuery(&req)
		if err != nil {
