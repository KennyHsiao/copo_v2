...
func MerchantQueryRateListViewHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantQueryRateListViewRequestX
		...
		l := merchantchannelrate.NewMerchantQueryRateListViewLogic(r.Context(), ctx)
		resp, err := l.MerchantQueryRateListView(req)
		if err != nil {
