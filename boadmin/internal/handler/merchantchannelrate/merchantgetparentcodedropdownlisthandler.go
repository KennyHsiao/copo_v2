...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantchannelrate"
...
func MerchantGetParentCodeDropDownListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateGetParentCodeDropDownListRequest
		...
		l := merchantchannelrate.NewMerchantGetParentCodeDropDownListLogic(r.Context(), ctx)
		resp, err := l.MerchantGetParentCodeDropDownList(req)
		if err != nil {
