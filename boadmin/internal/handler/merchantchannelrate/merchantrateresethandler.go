...
func MerchantRateResetHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateResetRequest
		...
		l := merchantchannelrate.NewMerchantRateResetLogic(r.Context(), ctx)
		err := l.MerchantRateReset(&req)
		if err != nil {
