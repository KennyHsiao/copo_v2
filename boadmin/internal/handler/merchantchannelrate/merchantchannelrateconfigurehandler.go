...
func MerchantChannelRateConfigureHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantChannelRateConfigureRequest
		...
		l := merchantchannelrate.NewMerchantChannelRateConfigureLogic(r.Context(), ctx)
		err := l.MerchantChannelRateConfigure(req)
		if err != nil {
