...
func MerchantGetCodeDropDownListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRateGetCodeDropDownListRequest
		...
		l := merchantchannelrate.NewMerchantGetCodeDropDownListLogic(r.Context(), ctx)
		resp, err := l.MerchantGetCodeDropDownList(req)
		if err != nil {
