...
func MerchantRatePayTypeListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantRatePayTypeListRequest
		...
		l := merchantchannelrate.NewMerchantRatePayTypeListLogic(r.Context(), ctx)
		resp, err := l.MerchantRatePayTypeList(&req, language)
		if err != nil {
