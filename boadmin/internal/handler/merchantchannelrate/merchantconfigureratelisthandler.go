...
func MerchantConfigureRateListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantConfigureRateListRequestX
		...
		l := merchantchannelrate.NewMerchantConfigureRateListLogic(r.Context(), ctx)
		resp, err := l.MerchantConfigureRateList(req)
		if err != nil {
