...
import (
	"com.copo/bo_service/boadmin/internal/logic/role"
...
func GetRoleDropDownListHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RoleDropDownItemRequest
		...
		l := role.NewGetRoleDropDownListLogic(r.Context(), ctx)
		resp, err := l.GetRoleDropDownList(&req)
		if err != nil {
