...
func RoleQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RoleQueryAllRequest
		...
		l := role.NewRoleQueryAllLogic(r.Context(), ctx)
		resp, err := l.RoleQueryAll(req)
		if err != nil {
