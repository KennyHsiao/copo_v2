...
import (
	"com.copo/bo_service/boadmin/internal/logic/download"
...
func DownloadCenterQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DownloadCenterQueryAllRequest
		...
		l := download.NewDownloadCenterQueryAllLogic(r.Context(), ctx)
		resp, err := l.DownloadCenterQueryAll(req)
		if err != nil {
