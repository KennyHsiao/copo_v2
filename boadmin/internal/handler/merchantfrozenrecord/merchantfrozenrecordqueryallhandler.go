...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantfrozenrecord"
...
func MerchantFrozenRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantFrozenRecordQueryAllRequest
		...
		l := merchantfrozenrecord.NewMerchantFrozenRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantFrozenRecordQueryAll(req)
		if err != nil {
