...
func MonthReportCreateForMonthHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommissionMonthReportCreateForMonthRequest
		...
		l := commissionMonthReport.NewMonthReportCreateForMonthLogic(r.Context(), ctx)
		err := l.MonthReportCreateForMonth(&req)
		if err != nil {
