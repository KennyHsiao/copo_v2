...
func MonthReportRecalculateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommissionMonthReportRecalculateRequest
		...
		l := commissionMonthReport.NewMonthReportRecalculateLogic(r.Context(), ctx)
		err := l.MonthReportRecalculate(&req)
		if err != nil {
