...
func MonthReportConfirmHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommissionMonthReportConfirmRequest
		...
		l := commissionMonthReport.NewMonthReportConfirmLogic(r.Context(), ctx)
		err := l.MonthReportConfirm(&req)
		if err != nil {
