...
func MonthReportQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommissionMonthReportQueryAllRequestX
		...
		l := commissionMonthReport.NewMonthReportQueryAllLogic(r.Context(), ctx)
		resp, err := l.MonthReportQueryAll(&req)
		if err != nil {
