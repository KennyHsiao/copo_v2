...
func MonthReportChangeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommissionMonthReportChangeRequest
		...
		l := commissionMonthReport.NewMonthReportChangeLogic(r.Context(), ctx)
		err := l.MonthReportChange(&req)
		if err != nil {
