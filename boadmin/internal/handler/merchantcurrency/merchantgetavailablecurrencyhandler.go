...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantcurrency"
...
func MerchantGetAvailableCurrencyHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantGetAvailableCurrencyRequest
		...
		l := merchantcurrency.NewMerchantGetAvailableCurrencyLogic(r.Context(), ctx)
		resp, err := l.MerchantGetAvailableCurrency(req)
		if err != nil {
