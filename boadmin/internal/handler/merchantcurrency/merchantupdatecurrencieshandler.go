...
func MerchantUpdateCurrenciesHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUpdateCurrenciesRequestX
		...
		l := merchantcurrency.NewMerchantUpdateCurrenciesLogic(r.Context(), ctx)
		err := l.MerchantUpdateCurrencies(req)
		if err != nil {
