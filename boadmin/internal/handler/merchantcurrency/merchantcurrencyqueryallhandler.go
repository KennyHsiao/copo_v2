...
func MerchantCurrencyQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantCurrencyQueryAllRequestX
		...
		l := merchantcurrency.NewMerchantCurrencyQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantCurrencyQueryAll(req)
		if err != nil {
