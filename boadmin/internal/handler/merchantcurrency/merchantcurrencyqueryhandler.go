...
func MerchantCurrencyQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantCurrencyQueryRequest
		...
		l := merchantcurrency.NewMerchantCurrencyQueryLogic(r.Context(), ctx)
		resp, err := l.MerchantCurrencyQuery(req)
		if err != nil {
