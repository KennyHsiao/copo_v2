...
func MerchantQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantQueryAllRequestX
		...
		l := merchant.NewMerchantQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantQueryAll(req)
		if err != nil {
