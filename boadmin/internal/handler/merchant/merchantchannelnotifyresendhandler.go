...
func MerchantChannelNotifyResendHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerhcantChannelNotifyResendRequest
		...
		l := merchant.NewMerchantChannelNotifyResendLogic(r.Context(), ctx)
		err := l.MerchantChannelNotifyResend(&req)
		if err != nil {
