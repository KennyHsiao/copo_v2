...
func SendNotifyChannelsHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantChannelNotifyRequest
		...
		l := merchant.NewSendNotifyChannelsLogic(r.Context(), ctx)
		err := l.SendNotifyChannels(&req)
		if err != nil {
