...
func MerchantQueryListViewTotalHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := merchant.NewMerchantQueryListViewTotalLogic(r.Context(), ctx)
		resp, err := l.MerchantQueryListViewTotal(&req)
		if err != nil {
