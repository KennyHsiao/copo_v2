...
func MerchantGetScrectKeyHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantGetScrectKeyRequest
		...
		l := merchant.NewMerchantGetScrectKeyLogic(r.Context(), ctx)
		resp, err := l.MerchantGetScrectKey(req)
		if err != nil {
