...
func MerchantUpdateStatusHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUpdateStatusRequest
		...
		l := merchant.NewMerchantUpdateStatusLogic(r.Context(), ctx)
		err := l.MerchantUpdateStatus(req)
		if err != nil {
