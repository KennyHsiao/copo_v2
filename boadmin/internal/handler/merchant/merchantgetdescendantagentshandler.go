...
func MerchantGetDescendantAgentsHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetDescendantAgentsRequest
		...
		l := merchant.NewMerchantGetDescendantAgentsLogic(r.Context(), ctx)
		resp, err := l.MerchantGetDescendantAgents(&req)
		if err != nil {
