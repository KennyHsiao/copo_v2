...
func MerchantChannelNotifyQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantChannelNotifyQueryRequest
		...
		l := merchant.NewMerchantChannelNotifyQueryLogic(r.Context(), ctx)
		resp, err := l.MerchantChannelNotifyQuery(&req)
		if err != nil {
