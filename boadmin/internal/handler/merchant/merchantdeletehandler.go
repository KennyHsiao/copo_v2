...
func MerchantDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantDeleteRequest
		...
		l := merchant.NewMerchantDeleteLogic(r.Context(), ctx)
		err := l.MerchantDelete(req)
		if err != nil {
