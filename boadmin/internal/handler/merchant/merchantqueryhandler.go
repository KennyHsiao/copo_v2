...
func MerchantQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantQueryRequest
		...
		l := merchant.NewMerchantQueryLogic(r.Context(), ctx)
		resp, err := l.MerchantQuery(req)
		if err != nil {
