...
func MerchantTransferParentAgentHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantTransferParentAgentRequest
		...
		l := merchant.NewMerchantTransferParentAgentLogic(r.Context(), ctx)
		err := l.MerchantTransferParentAgent(req)
		if err != nil {
