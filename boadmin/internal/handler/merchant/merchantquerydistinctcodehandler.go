...
func MerchantQueryDistinctCodeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantQueryDistinctCode
		...
		l := merchant.NewMerchantQueryDistinctCodeLogic(r.Context(), ctx)
		resp, err := l.MerchantQueryDistinctCode(req)
		if err != nil {
