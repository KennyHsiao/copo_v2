...
func MerchantResetPasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantResetPasswordRequest
		...
		l := merchant.NewMerchantResetPasswordLogic(r.Context(), ctx)
		err := l.MerchantResetPassword(req)
		if err != nil {
