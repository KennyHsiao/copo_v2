...
func MerchantQueryListViewHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := merchant.NewMerchantQueryListViewLogic(r.Context(), ctx)
		resp, err := l.MerchantQueryListView(req)
		if err != nil {
