...
func MerchantUpdateAgentStatusHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUpdateAgentStatusRequest
		...
		l := merchant.NewMerchantUpdateAgentStatusLogic(r.Context(), ctx)
		err := l.MerchantUpdateAgentStatus(req)
		if err != nil {
