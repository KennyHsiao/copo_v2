...
func MerchantCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantCreateRequest
		...
		l := merchant.NewMerchantCreateLogic(r.Context(), ctx)
		err := l.MerchantCreate(req)
		if err != nil {
