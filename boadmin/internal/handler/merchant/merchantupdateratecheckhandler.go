...
func MerchantUpdateRateCheckHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUpdateRateCheckRequest
		...
		l := merchant.NewMerchantUpdateRateCheckLogic(r.Context(), ctx)
		err := l.MerchantUpdateRateCheck(&req)
		if err != nil {
