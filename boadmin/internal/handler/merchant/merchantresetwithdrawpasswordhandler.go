...
func MerchantResetWithdrawPasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := merchant.NewMerchantResetWithdrawPasswordLogic(r.Context(), ctx)
		err := l.MerchantResetWithdrawPassword(req)
		if err != nil {
