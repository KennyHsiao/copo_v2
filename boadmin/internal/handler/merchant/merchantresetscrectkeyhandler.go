...
func MerchantResetScrectKeyHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantResetScrectKeyRequest
		...
		l := merchant.NewMerchantResetScrectKeyLogic(r.Context(), ctx)
		err := l.MerchantResetScrectKey(req)
		if err != nil {
