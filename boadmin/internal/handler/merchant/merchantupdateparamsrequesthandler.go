...
func MerchantUpdateParamsRequestHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUpdateParamsRequest
		...
		l := merchant.NewMerchantUpdateParamsRequestLogic(r.Context(), ctx)
		err := l.MerchantUpdateParamsRequest(&req)
		if err != nil {
