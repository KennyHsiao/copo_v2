...
func MerchantUpdateBillLadingTypeHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantUpdateBillLadingTypeRequest
		...
		l := merchant.NewMerchantUpdateBillLadingTypeLogic(r.Context(), ctx)
		err := l.MerchantUpdateBillLadingType(req)
		if err != nil {
