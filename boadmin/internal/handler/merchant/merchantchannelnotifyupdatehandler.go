...
func MerchantChannelNotifyUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantChannelNotifyUpdateRequest
		...
		l := merchant.NewMerchantChannelNotifyUpdateLogic(r.Context(), ctx)
		resp, err := l.MerchantChannelNotifyUpdate(&req)
		if err != nil {
