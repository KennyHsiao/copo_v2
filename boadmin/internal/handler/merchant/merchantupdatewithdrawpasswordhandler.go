...
func MerchantUpdateWithdrawPasswordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateWithdrawPasswordRequest
		...
		l := merchant.NewMerchantUpdateWithdrawPasswordLogic(r.Context(), ctx)
		err := l.MerchantUpdateWithdrawPassword(req)
		if err != nil {
