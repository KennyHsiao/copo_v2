...
func PayTypeQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PayTypeQueryAllRequestX
		...
		l := paytype.NewPayTypeQueryAllLogic(r.Context(), ctx)
		resp, err := l.PayTypeQueryAll(req)
		if err != nil {
