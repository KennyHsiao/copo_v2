...
func PayTypeBatchSortHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchSortRequest
		...
		l := paytype.NewPayTypeBatchSortLogic(r.Context(), ctx)
		err := l.PayTypeBatchSort(&req)
		if err != nil {
