...
func PayTypeQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PayTypeQueryRequest
		...
		l := paytype.NewPayTypeQueryLogic(r.Context(), ctx)
		resp, err := l.PayTypeQuery(req)
		if err != nil {
