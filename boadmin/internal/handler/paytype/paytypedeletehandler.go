...
func PayTypeDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PayTypeDeleteRequest
		...
		l := paytype.NewPayTypeDeleteLogic(r.Context(), ctx)
		err := l.PayTypeDelete(req)
		if err != nil {
