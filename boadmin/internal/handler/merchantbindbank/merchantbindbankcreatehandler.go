...
func MerchantBindBankCreateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBindBankCreateRequest
		...
		l := merchantbindbank.NewMerchantBindBankCreateLogic(r.Context(), ctx)
		err := l.MerchantBindBankCreate(req)
		if err != nil {
