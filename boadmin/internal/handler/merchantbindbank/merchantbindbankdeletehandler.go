...
func MerchantBindBankDeleteHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBindBankDeleteRequest
		...
		l := merchantbindbank.NewMerchantBindBankDeleteLogic(r.Context(), ctx)
		err := l.MerchantBindBankDelete(req)
		if err != nil {
