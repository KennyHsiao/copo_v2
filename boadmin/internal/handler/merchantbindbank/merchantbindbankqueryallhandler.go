...
import (
	"com.copo/bo_service/boadmin/internal/logic/merchantbindbank"
...
func MerchantBindBankQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBindBankQueryAllRequest
		...
		l := merchantbindbank.NewMerchantBindBankQueryAllLogic(r.Context(), ctx)
		resp, err := l.MerchantBindBankQueryAll(req)
		if err != nil {
