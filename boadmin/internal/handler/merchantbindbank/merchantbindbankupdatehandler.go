...
func MerchantBindBankUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBindBankUpdateRequest
		...
		l := merchantbindbank.NewMerchantBindBankUpdateLogic(r.Context(), ctx)
		err := l.MerchantBindBankUpdate(req)
		if err != nil {
