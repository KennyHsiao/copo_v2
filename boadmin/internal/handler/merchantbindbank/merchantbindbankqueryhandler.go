...
func MerchantBindBankQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MerchantBindBankQueryRequest
		...
		l := merchantbindbank.NewMerchantBindBankQueryLogic(r.Context(), ctx)
		resp, err := l.MerchantBindBankQuery(req)
		if err != nil {
