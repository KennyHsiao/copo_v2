...
func BankQueryForBKHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankQueryForBKRequestX
		...
		l := banks.NewBankQueryForBKLogic(r.Context(), ctx)
		resp, err := l.BankQueryForBK(&req)
		if err != nil {
