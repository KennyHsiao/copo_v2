...
func BankQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankQueryRequest
		...
		l := banks.NewBankQueryLogic(r.Context(), ctx)
		resp, err := l.BankQuery(req)
		if err != nil {
