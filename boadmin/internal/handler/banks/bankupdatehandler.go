...
func BankUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankUpdateRequest
		...
		l := banks.NewBankUpdateLogic(r.Context(), ctx)
		err := l.BankUpdate(req)
		if err != nil {
