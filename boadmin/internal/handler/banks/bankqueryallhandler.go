...
func BankQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BankQueryAllRequestX
		...
		l := banks.NewBankQueryAllLogic(r.Context(), ctx)
		resp, err := l.BankQueryAll(req)
		if err != nil {
