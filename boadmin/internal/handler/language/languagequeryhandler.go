...
func LanguageQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LanguageQueryRequest
		...
		l := language.NewLanguageQueryLogic(r.Context(), ctx)
		resp, err := l.LanguageQuery(req)
		if err != nil {
