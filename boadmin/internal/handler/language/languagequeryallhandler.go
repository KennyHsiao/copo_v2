...
import (
	"com.copo/bo_service/boadmin/internal/logic/language"
...
func LanguageQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LanguageQueryAllRequest
		...
		l := language.NewLanguageQueryAllLogic(r.Context(), ctx)
		resp, err := l.LanguageQueryAll(req)
		if err != nil {
