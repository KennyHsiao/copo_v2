...
func ReceiptRecordMerchantExcelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewReceiptRecordMerchantExcelLogic(r.Context(), ctx)
		xlsx, err := l.ReceiptRecordMerchantExcel(&req)
		if err != nil {
