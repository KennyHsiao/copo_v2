...
func ConfirmProxyPayOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ConfirmProxyPayOrderRequest
		...
		l := orderrecord.NewConfirmProxyPayOrderLogic(r.Context(), ctx)
		err := l.ConfirmProxyPayOrder(&req)
		if err != nil {
