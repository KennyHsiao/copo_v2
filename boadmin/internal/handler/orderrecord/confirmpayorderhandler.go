...
func ConfirmPayOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ConfirmPayOrderRequest
		...
		l := orderrecord.NewConfirmPayOrderLogic(r.Context(), ctx)
		err := l.ConfirmPayOrder(req)
		if err != nil {
