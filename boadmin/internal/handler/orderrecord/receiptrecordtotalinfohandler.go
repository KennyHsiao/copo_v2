...
func ReceiptRecordTotalInfoHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewReceiptRecordTotalInfoLogic(r.Context(), ctx)
		resp, err := l.ReceiptRecordTotalInfo(req)
		if err != nil {
