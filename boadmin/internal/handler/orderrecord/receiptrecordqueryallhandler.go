...
func ReceiptRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewReceiptRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.ReceiptRecordQueryAll(req)
		if err != nil {
