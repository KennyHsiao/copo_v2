...
func FrozenRecordQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FrozenRecordQueryAllRequestX
		...
		l := orderrecord.NewFrozenRecordQueryAllLogic(r.Context(), ctx)
		resp, err := l.FrozenRecordQueryAll(req)
		if err != nil {
