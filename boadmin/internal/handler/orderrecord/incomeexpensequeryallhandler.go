...
func IncomeExpenseQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewIncomeExpenseQueryAllLogic(r.Context(), ctx)
		resp, err := l.IncomeExpenseQueryAll(req)
		if err != nil {
