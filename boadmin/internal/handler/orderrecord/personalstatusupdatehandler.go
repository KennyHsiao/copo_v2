...
func PersonalStatusUpdateHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PersonalStatusUpdateResponse
		...
		l := orderrecord.NewPersonalStatusUpdateLogic(r.Context(), ctx)
		err := l.PersonalStatusUpdate(req)
		if err != nil {
