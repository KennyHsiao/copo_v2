...
func WithdrawCallBackMerchantHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ProxyPayCallbackMerchantRequest
		...
		l := orderrecord.NewWithdrawCallBackMerchantLogic(r.Context(), ctx)
		err := l.WithdrawCallBackMerchant(&req)
		if err != nil {
