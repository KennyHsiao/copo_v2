...
func RecoverReceiptOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RecoverReceiptOrderRequest
		...
		l := orderrecord.NewRecoverReceiptOrderLogic(r.Context(), ctx)
		err := l.RecoverReceiptOrder(&req)
		if err != nil {
