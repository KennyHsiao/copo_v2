...
func ReversalRecordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ReversalRecordRequest
		...
		l := orderrecord.NewReversalRecordLogic(r.Context(), ctx)
		err := l.ReversalRecord(req)
		if err != nil {
