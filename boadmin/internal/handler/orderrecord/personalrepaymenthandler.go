...
func PersonalRepaymentHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PersonalRepaymentRequestX
		...
		l := orderrecord.NewPersonalRepaymentLogic(r.Context(), ctx)
		resp, err := l.PersonalRepayment(req)
		if err != nil {
