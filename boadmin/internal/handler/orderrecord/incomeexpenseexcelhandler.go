...
func IncomeExpenseExcelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewIncomeExpenseExcelAllLogic(r.Context(), ctx)
		err := l.IncomeExpenseExcelAll(&req)
		if err != nil {
