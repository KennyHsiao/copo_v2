...
func PtBalanceRecordsQueryAllHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PtBalanceRecordsQueryRequestX
		...
		l := orderrecord.NewPtBalanceRecordsQueryAllLogic(r.Context(), ctx)
		resp, err := l.PtBalanceRecordsQueryAll(req)
		if err != nil {
