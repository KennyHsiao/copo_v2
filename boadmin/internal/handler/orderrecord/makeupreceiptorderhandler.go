...
func MakeUpReceiptOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MakeUpReceiptOrderRequest
		...
		l := orderrecord.NewMakeUpReceiptOrderLogic(r.Context(), ctx)
		err := l.MakeUpReceiptOrder(req)
		if err != nil {
