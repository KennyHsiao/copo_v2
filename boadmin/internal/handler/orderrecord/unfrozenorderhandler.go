...
func UnfrozenOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnfrozenOrderRequest
		...
		l := orderrecord.NewUnfrozenOrderLogic(r.Context(), ctx)
		err := l.UnfrozenOrder(req)
		if err != nil {
