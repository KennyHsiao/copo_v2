...
func OrderChannelRecordHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OrderChannelRecordReqeust
		...
		l := orderrecord.NewOrderChannelRecordLogic(r.Context(), ctx)
		resp, err := l.OrderChannelRecord(req)
		if err != nil {
