...
func DeductRecordExcelHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewDeductRecordExcelLogic(r.Context(), ctx)
		xlsx, excelName, err := l.DeductRecordExcel(req)
		if err != nil {
