...
func FrozenReceiptOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FrozenReceiptOrderRequest
		...
		l := orderrecord.NewFrozenReceiptOrderLogic(r.Context(), ctx)
		err := l.FrozenReceiptOrder(req)
		if err != nil {
