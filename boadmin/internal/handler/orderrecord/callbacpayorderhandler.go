...
func CallBacPayOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CallBackPayOrderRequest
		...
		l := orderrecord.NewCallBacPayOrderLogic(r.Context(), ctx)
		err := l.CallBacPayOrder(req)
		if err != nil {
