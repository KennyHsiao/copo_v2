...
func DeductRecordTotalInfoHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := orderrecord.NewDeductRecordTotalInfoLogic(r.Context(), ctx)
		resp, err := l.DeductRecordTotalInfo(req)
		if err != nil {
