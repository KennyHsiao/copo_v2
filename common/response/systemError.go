...
var (
	...
	STATUS_ERROR_OPERATION_PROHIBITED             = "1080000" //"状态错误,禁止操作"
	THIS_BULLETIN_HAS_BEEN_SENT                   = "1080001" //"此公告已发送"
	STATUS_ERROR_FORBIDDEN_TO_DELETE              = "1080002" //"状态错误,禁止删除"
	STATU_ERROR_PROHIBIT_RECYCLING                = "1080003" //"状态错误,禁止回收"
	STATUS_ERROR_FORBIDDEN_TO_SEND                = "1080004" //"状态错误,禁止发送"
	STATUS_ERROR_STORAGE_PROHIBITED               = "1080005" //"状态错误,禁止储存"
	ANNOUNCEMENT_FAILED_TO_SEND                   = "1080006" //"公告发送失败"
)
